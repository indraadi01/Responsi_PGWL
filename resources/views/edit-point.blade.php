            ...
            <div class="modal-body">
                <form action="{{ route('update-point', $point->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="remark" name="remark" value="{{ $point->remark }}" placeholder="Fill point name">
                    </div>
                    <div class="mb-3">
                        <label for="lcode" class="form-label">Description</label>
                        <textarea class="form-control" id="lcode" name="lcode" rows="3">{{ $point->lcode }}</textarea>
                    </div>
                    <div class="mb-3">
